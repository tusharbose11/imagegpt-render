...
os.environ["REPLICATE_API_TOKEN"] = "r8_X3hqznE2wOBda5v8YbvMuiVKZjeqDqz3oMW4P"
app = Flask(__name__)
...
def index():
    if request.method == "POST":
        ...
        headers = {'Authorization': 'Token r8_X3hqznE2wOBda5v8YbvMuiVKZjeqDqz3oMW4P','Content-Type': 'application/json'}
